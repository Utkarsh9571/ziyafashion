      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 pt-14 sm:pt-18 pb-12 sm:pb-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-20">
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-3.5">
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-[#2b2f35] hover:bg-[#ff7d86] text-neutral-200 hover:text-white flex items-center justify-center transition-all duration-200 border border-neutral-600/60 hover:border-[#ff7d86] shadow-sm hover:scale-105"
                >
          ...
          <div className="space-y-4">
            <h3 className="text-[#ff7d86] font-bold text-lg tracking-wide">
              Boutique
            </h3>
