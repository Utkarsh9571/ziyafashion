        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5 text-left z-10">
            ...
            <div className="pt-2 sm:pt-3">
              <Link
                href="/appointment"
                className="inline-flex items-center gap-3 bg-white text-[#ff7d86] hover:bg-neutral-50 px-7 sm:px-8 py-3 sm:py-3.5 rounded-full font-bold text-xs sm:text-sm uppercase tracking-wider shadow-md transition-all hover:scale-105 active:scale-95"
              >
                <span>BOOK AN APPOINTMENT</span>
                <div className="w-6 h-6 rounded-full bg-[#ff7d86] text-white flex items-center justify-center shrink-0">
          ...
          <div className="lg:col-span-5 relative flex justify-center lg:justify-end items-center mt-6 lg:mt-0">
            ...
            <div className="absolute -left-4 sm:-left-6 top-1/2 -translate-y-1/2 w-40 sm:w-48 h-40 sm:h-48 rounded-full bg-[#e85661]/70 pointer-events-none" />
