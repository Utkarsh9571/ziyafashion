  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-[36px] bg-gradient-to-r from-[#e84e4e] via-[#ea5353] to-[#f06767] text-white p-8 sm:p-12 lg:p-16 overflow-hidden shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-8 space-y-5 text-center lg:text-left">
              ...
              <p className="text-white/90 text-base sm:text-lg max-w-2xl font-light leading-relaxed">
                Have a design in mind or looking for a custom-tailored outfit for an upcoming celebration? Book a private appointment with Ziya Fashion and discuss your requirements with our design team.
              </p>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <Link
                  href="/contact"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 text-white border border-white/40 px-6 py-4 rounded-full font-semibold text-sm backdrop-blur-sm transition-all"
                >
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end">
              <div className="relative w-64 h-64 sm:w-72 sm:h-72 rounded-full border-4 border-white/30 overflow-hidden shadow-2xl bg-white/10">
                <Image
                  ...
                  alt="Ziya Fashion Bespoke Fitting"
                  fill
