        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5 text-left z-10">
            ...
            <div className="pt-2 sm:pt-3">
              <Link
                href="/designs"
                className="inline-flex items-center gap-3 bg-white text-[#ff7d86] hover:bg-neutral-50 px-7 sm:px-8 py-3 sm:py-3.5 rounded-full font-bold text-xs sm:text-sm shadow-md transition-all hover:scale-105 active:scale-95"
              >
